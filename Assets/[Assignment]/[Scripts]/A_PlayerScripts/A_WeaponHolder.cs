...
public class A_WeaponHolder : MonoBehaviour
{
    ...
    A_WeaponComponent equippedWeapon;
    ...
    void Start()
    {
        ...
        playerController = GetComponent<A_PlayerController>();
        ...
        equippedWeapon = SpawnedWeapon.GetComponent<A_WeaponComponent>();
